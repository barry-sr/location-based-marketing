...
// $sql="SELECT id, username, ( 6371 * acos ( cos ( radians($lat) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($lng) ) + sin ( radians($lat) ) * sin( radians( lat ) ) ) ) < radius AS result FROM circle WHERE username='$username' AND NOW() BETWEEN startDateTime AND endDateTime Having result=1";


// get age 
// SELECT (YEAR(CURDATE())-YEAR(b_date)) AS age FROM signup
