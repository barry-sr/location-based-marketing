...
<div class="content"> 
  ...
  <div class="col-lg-3 col-lg-3 col-md-3 col-sm-12" style="background-color: white; height: 675px;">
       <form action="javascript:true;" name="form" method="POST">
                ...
                <div class="form-group">
                  ...
                  <!-- <br> -->
                  <div class="col-lg-5">
                  <input type="number" class="form-control form-control-sm" placeholder="To" id='ageTo' min="0" max="100" required="required">
                  </div>
                  </div>
                </div>

                <div class="form-group">
                <select id="categories" class="selectpicker" title="Choose Category" required="required" multiple>
                    <?php 
              ...
              <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="address" placeholder="type address" autocomplete="off" onblur="myFunction()"  required>
                  <br>
              </div>

              <div class="form-group">
                <input class="btn btn-primary draw" id="draw" type="button" value="re-draw">
...
<!-- <div class="content">
   <div class="row  circle-padding"> -->
    <!-- map section -->
    <!-- <div class="col-lg-3"  id="map" style="height: 673px; width: 1000px;"></div> -->
          <!-- input section -->
         <!--  <div class="col-sm-2">
            <form action="javascript:true;" name="form" method="POST">
                <div class="form-group">
              ...
              <div class="form-group"> -->
               <!--  <label>Draw Polygon</label>
                <input class="form-control" type="text" id="point1" placeholder="point1" autocomplete="off" required>
                <input class="form-control" type="number" id="point2" placeholder="point2" required>
                <input class="form-control" type="number" id="point3" placeholder="point3" required><br> -->
      <!--           <input class="btn btn-primary draw" id="draw" type="button" value="re-draw">
                <input class="btn btn-success save" type="submit" value="save"><br>
                </div>
            </form>
...
google.maps.event.addListener(drawingManager, 'overlaycomplete', function(e) {
      if (e.type != google.maps.drawing.OverlayType.MARKER) {
          ...
          setPolygon(e);
        // //event to handle polygon changes
...
//store polygon data into db
$('form').submit(function(event){
  if(polygon){
      var polygonData = [];
      var points = polygon.getPath(); 
      for(var i=0; i < polygon.getPath().getLength(); i++){
          polygonData.push(points.getAt(i).lat()+' '+points.getAt(i).lng());
        }
      ...
      polygonInfo.push(username, title, description, startDateTime, endDateTime, email, gender, ageFrom, ageTo, categories);
  ...
  if(ageFrom >= ageTo){
    ...
    event.preventDefault();
     ...
     $.ajax({
          method: "POST",
          url: "http://210.19.254.111/project/savePolygon.php",
          data: {data: 
                  {polygonInfo, polygonData}
                }
         })
          .done(function( msg ){
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAMMYiE-JJBJGtUNxzSXtcQPCcLp-cDgKE&libraries=places,drawing&callback=initMap"
    async defer></script>
