...
<div class="content">
      ...
      <div class='col-lg-9'>
        <div class="row">
           <div class="col-xl-6" id="mapHeader">Geofences on Map</div>
           <div class="col-xl-6" id="map" style=" height: 655px;"></div>
         </div>  
      </div>
      <!-- end of map section -->
      ...
      <div class='col-lg-3'>
        <div class="row">
          ...
          <div class="col-lg-12 col-sm-4 col-width">
            <div class="row" style="align-items: center;  position: relative; float: left; top: 50%; left: 50%; transform: translate(-50%, -50%);  vertical-align: middle;">
              <a href="#" data-toggle="modal" data-target="#allGeofencesModal">
              <div class="col-xl-4 n-geofence">
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="modal-body">
                          <table id="allGoedetailstable" class="display table-responsive" style="width:100%">
                              <thead>
                                  <tr>
                                      <th>Id</th>
                                      <th>Geofence Name</th>
          ...
          <div class="col-lg-12 col-sm-4 col-width">
            <div class="row" style="align-items: center;  position: relative; float: left; top: 50%; left: 50%; transform: translate(-50%, -50%);  vertical-align: middle;">
              <a href="#" data-toggle="modal" data-target="#allAcgeofencesModal">
              <div class="col-xl-4 ac-geofence">
                
                    <div class="col-lg-3">
                      <i class="fas fa-map-marker fa-4x"></i>
                    </div>
                    <div class="col-lg-9">
                        <h># of Ac geofene</h><br>
                  ...
                  <!-- Modal -->
                  <div class="modal fade" id="allAcgeofencesModal" role="dialog">
                    <div class="modal-dialog modal-lg">
                      <!-- Modal content-->
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Details of All Active Geofences</h4>
                        </div>
                  <div class="modal-body">
                    <table id="allActiveGoedetailstable" class="display table-responsive" style="width:100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Geofence Name</th>
          ...
          <div class="col-lg-12 col-sm-4 col-width">
            <div class="row" style="align-items: center;  position: relative; float: left; top: 50%; left: 50%; transform: translate(-50%, -50%);  vertical-align: middle;">
              <a href="#" data-toggle="modal" data-target="#detailofUsersinsideGeoModal">
              <div class="col-xl-4 userin-geofence">
                    <div class="col-lg-3">
                      <i class="fas fa-location-arrow fa-4x"></i>
                    </div>
                    <div class="col-lg-9">
                        <h># of UI geofene</h><br>
                  ...
                  <!-- Modal -->
                  <div class="modal fade" id="detailofUsersinsideGeoModal" role="dialog">
                    <div class="modal-dialog modal-lg">
                      <!-- Modal content-->
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Details of All Users Inside Geofences</h4>
                        </div>
                  <div class="modal-body">
                    <table id="detailsofUsersinsideGeoTable" class="display table-responsive" style="width:100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Geofence Name</th>
